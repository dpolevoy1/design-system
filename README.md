...
| Subpath | Contents |
|---------|----------|
| `@assemble/design-system` | `Tooltip`, `ToggleIndicator`, `Spinner`, `Input`, `PrimaryButton`, `SecondaryButton`, `TertiaryButton`, `DeleteButton`, … |
...
**`sm`** (32px) and **`md`** (38px) per Figma overview [**8835:179**](https://www.figma.com/design/MHT2FB3YBrO2auBzNTbCkD/?node-id=8835-179) §08; borders, shadows, and validation are aligned with the state matrix [**8835:688**](https://www.figma.com/design/MHT2FB3YBrO2auBzNTbCkD/?node-id=8835-688). **Product rules:** **[`docs/INPUT.md`](./docs/INPUT.md)**.
...
| [`docs/INPUT.md`](./docs/INPUT.md) | **Input usage** from [**8835:179**](https://www.figma.com/design/MHT2FB3YBrO2auBzNTbCkD/?node-id=8835-179) + states [**8835:688**](https://www.figma.com/design/MHT2FB3YBrO2auBzNTbCkD/?node-id=8835-688). |
| [`src/Input`](./src/Input) | Single-line **`<Input />`** with optional label, helper, `validation`, `endAdornment`. |
